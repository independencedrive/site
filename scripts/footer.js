        ...
        <grid-item id="xxIYmsi">
          <grid-box id="rkqUGeB">
            ...
            <grid-item id="kxFdtGz">
              <a id="lSPTMRn" href="https://www.google.com/maps/search/?api=1&amp;query=83+Rue+Michel+Ange,+34070+Montpellier" data-type="a-link" target="_self" class="">83 Rue Michel Ange, 34070 Montpellier</a>
            </grid-item>
            <grid-item id="ObTgPrt">
              <a id="iReVUOi" href="https://www.facebook.com/share/5rUeTrLHtpJt3UWt/" data-type="a-link" target="_blank" class="">
            ...
            <grid-item id="pzJgETt">
              <a id="QBUJeeR" href="https://www.tiktok.com/@drivingschool_tv?_t=8ojG0WE6Cob&amp;_r=1" data-type="a-link" target="_self" class="">
            ...
            <grid-item id="ZptisHS">
              <a id="zLwJfuG" href="https://www.instagram.com/independencedrivetv?igsh=MXEwaDJtaW5laW12Mg==" data-type="a-link" target="_self" class="">
        ...
        <grid-item id="SLfsEpf">
          <grid-box id="UybQYLA">
            ...
            <grid-item id="ZPaOvUt">
              <a id="wyWkjOt" data-type="a-link" target="_self" class="">Dimanche : Fermé</a>
            </grid-box>
        </grid-item>
